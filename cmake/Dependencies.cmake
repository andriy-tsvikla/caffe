...
if(BUILD_python)
  ...
  if(NOT Boost_PYTHON_FOUND)
        find_package(Boost 1.65.1 COMPONENTS python)
  endif()
  #else()
  ...
  #endif()
  if(PYTHONLIBS_FOUND)
    message(STATUS "PYTHONLIBS_FOUND -- TRUE")
  else()
    message(STATUS "PYTHONLIBS_FOUND -- FALSE")
  endif()
  ...
  if(NUMPY_FOUND)
    message(STATUS "NUMPY_FOUND -- TRUE")
  else()
    message(STATUS "NUMPY_FOUND -- FALSE")
  endif()
